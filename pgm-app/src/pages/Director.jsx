        ...
        switch (msg.type) {
          case "camera-connected": {
            setCameras(prev => {
              ...
              if (updated.length === 1) setProgram(msg.cameraId);
              if (updated.length === 2) setPreview(msg.cameraId);
              return updated;
            });
